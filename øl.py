...
navn = ['Punk IPA', 'Aarhus Tribute', 'Santa Gose', 'Red Noses', 'Christmas Ale', 'Yule Juice', 'Yuzual Suspect']
bryggeri = ['Brewdog', 'Aarhus Bryghus', 'To Øl', 'Anarkist', 'Jacobsen', 'Amager Bryghus', 'To Øl']
type = ['IPA', 'Barleywine', 'Sour', 'Red Ale', 'Red Ale', 'IPA', 'Sour']
procent = [5.4, 9, 4, 5.5, 7.5, 6.5, 4]
...
duft_ems = [4, 4, 5, 2, 4, 5, 1]
smag_ems = [8, 6, 9, 4, 7, 6, 6]
helhedsoplevelse_ems = [4, 3, 5, 2, 3, 4, 4]
...
duft_tejl = [5, 2, 4, 2, 4, 4, 1]
smag_tejl = [7, 9, 7, 5, 7, 6, 8]
helhedsoplevelse_tejl = [4, 3, 4, 3, 4, 2, 4]
...
duft_miks = [3, 4, 4, 2, 3, 5, 3]
smag_miks = [7, 6, 9, 4, 6, 7, 9]
helhedsoplevelse_miks = [3, 3, 5, 2, 3, 3, 5]
